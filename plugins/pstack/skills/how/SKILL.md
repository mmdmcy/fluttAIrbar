...
- `model`: your configured how-explorer model (default `auto`)
- `readonly`: `true`
...
- subagent type: general-purpose
- `model`: your configured how-explainer model (default `auto`)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `auto`, `auto`, `auto`, `auto`), all in a single message.
